...
<table width="100%" border="0" class="vl">
          ...
          <? } elseif($success) { ?>
            ...
            <tr>
                <td style="padding: 5px 0px 15px 0px; border-bottom: 1px dashed #dfe6e6"><strong>Dispatch Forms</strong></td>
            </tr>
            <tr>
              <td>
	<table width="100%" border="0" class="vl">
                            ...
                            <tr onMouseover="this.bgColor='#f0e6dd'" onMouseout="this.bgColor='#FFFFFF'">
                                ...
                                <td class="<?=($count<mysqlnumrows($xquery)?"vl_tdstandard":"vl_tdnoborder")?>">
                               	<? if(!getDetailedTableInfo2("vl_forms_clinicalrequest_dispatch","refNumber='$q[refNumber]' limit 1","id")) { ?>
                                	<div class="vls_grey" style="padding:3px 0px 0px 0px"><a href="/generateforms/dispatch/<?=$q["refNumber"]?>/">Input&nbsp;Dispatch&nbsp;Date</a></div>
                                <? } else { ?>
                                	<div class="vls_grey" style="padding:3px 0px 0px 0px">Dispatched on <?=getFormattedDate(getDetailedTableInfo2("vl_forms_clinicalrequest_dispatch","refNumber='$q[refNumber]' limit 1","dispatchDate"))?> (<a href="/generateforms/dispatch/<?=$q["refNumber"]?>/">edit</a>)</div>
                                <? } ?>
								</td>
                            </tr>
                        <? } ?>
