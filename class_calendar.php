...
class Calendar {
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1) {
    	...
    	$s .= "<tr>\n";
    	$s .= "<td align=\"center\" class=\"caption\" valign=\"top\" width=\"30\">" . (($prevMonth == "") ? "&nbsp;" : "<a href=\"$prevMonth\" class=\"vl_white_link\">&lt;&lt;</a>")  . "</td>\n";
    	$s .= "<td align=\"center\" class=\"caption\" valign=\"top\">$header</td>\n"; 
    	$s .= "<td align=\"center\" class=\"caption\" valign=\"top\" width=\"30\">" . (($nextMonth == "") ? "&nbsp;" : "<a href=\"$nextMonth\" class=\"vl_white_link\">&gt;&gt;</a>")  . "</td>\n";
    	$s .= "</tr>";
		$s .= "</table>\n";
...
class MyCalendar extends Calendar {
    function getCalendarLink($month, $year) {
		...
		return "?a=calendar&month=$month&year=$year"; 
	}
    ...
    function getDateLink($day, $month, $year) {
        ...
        $link = 0;
        if($this->isDateInDB($mydate)) {
			$link = "?a=calendar&day=$day&month=$month&year=$year";
        }
		return $link;
    }
}
