...
<table width="100%" border="0" class="vl">
	...
	<table width="100%" border="0" class="vl">
        ...
        ?>
            <tr>
	            <td style="padding:10px 0px 10px 0px" class="vls_grey"><strong><?=mysqlnumrows($xquery)?></strong> form<?=(mysqlnumrows($xquery)!=1?"s":"")?> found while searching for <strong><?=$searchQuery?></strong></td>
            </tr>
                <tr>
                  <td>
            ...
            <tr>
	            <td style="padding:20px 0px 0px 0px"><a href="/generateforms/">Return to Forms</a> :: <a href="/dashboard/">Return to Dashboard</a></td>
            </tr>
	    <? } else { ?>
            <tr>
                <td class="vl_error">
                There are No Forms on the System matching the keyword <strong><?=$searchQuery?></strong>!<br />
				<a href="/generateforms/">Search again?</a></td>
            </tr>
	    <? } ?>
		</table>
              </td>
