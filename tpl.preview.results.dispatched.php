...
//dispatch details
$dispatchDate=0;
$dispatchDate=getDetailedTableInfo2("vl_logs_dispatchedresults","sampleID='$sampleID' and worksheetID='$worksheetID' limit 1","dateDispatched");

$destinationFacilityID=0;
$destinationFacilityID=getDetailedTableInfo2("vl_logs_dispatchedresults","sampleID='$sampleID' and worksheetID='$worksheetID' limit 1","facilityID");
?>
    ...
    <tr>
        <td>
            ...
            <tr>
                <td>
                  <fieldset style="width: 100%">
            <legend><strong>DISPATCH DETAILS</strong></legend>
                        <div style="padding:5px 0px 0px 0px">
						<table width="100%" border="0" class="vl">
                            <tr>
							<td width="30%" style="padding:4px 0px; border-bottom: 1px dashed #dfe6e6">Dispatch&nbsp;Date</td>
                              <td width="70%" style="padding:4px 0px; border-bottom: 1px dashed #dfe6e6"><?=getFormattedDate($dispatchDate)?></td>
                            </tr>
                            <tr>
							<td style="padding:4px 0px">Destination&nbsp;Facility</td>
                              <td style="padding:4px 0px"><?=getDetailedTableInfo2("vl_facilities","id='$destinationFacilityID' limit 1","facility")?></td>
                            </tr>
                      </table>
                        </div>
                  </fieldset>
