...
.vl11_grey, .vl11_grey a:link, .vl11_grey a:visited {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 11px;
	color: #CCC;
}
...
.vl10_grey, .vl10_grey a:link, .vl10_grey a:visited {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 10px;
	color: #CCC;
}
...
<table width="95%" border="0" cellpadding="0" cellspacing="0" class="vl">
  <!-- Start Header -->
  <tr>
    <td width="5%" style="padding:5px; border-top: 1px solid #333; border-bottom: 1px solid #333; border-left: 1px solid #333"><img src="/images/uganda.emblem.gif"></td>
    <td width="90%" style="padding:5px; border: 1px solid #333" align="center"><strong>MINISTRY OF HEALTH UGANDA<br>NATIONAL AIDS CONTROL PROGRAM (ACP)</strong></td>
    <td width="5%" style="padding:5px; border-top: 1px solid #333; border-right: 1px solid #333; border-bottom: 1px solid #333" align="center"><strong>FORM&nbsp;#</strong></td>
  </tr>
  <!-- End Header -->
  <!-- Start Line 1 Text -->
  <tr>
    <td style="padding:5px">&nbsp;</td>
    <td style="padding:10px 5px; border-bottom: 1px solid #333" align="center">Lab Request Form for HIV Viral Load Analysis</td>
    <td style="padding:5px">&nbsp;</td>
  </tr>
  <!-- End Line 1 Text -->
  <!-- Start Line 2 Text -->
  <tr>
    <td style="padding:5px">&nbsp;</td>
    <td style="padding:10px 5px 5px 5px" align="center"><em>Sample Identification Information: To be completed by Health Facility Laboratory Staff</em></td>
    <td style="padding:5px">&nbsp;</td>
  </tr>
  <!-- End Line 2 Text -->
</table>
				...
				<table width="100%" border="0" class="vl">
					...
					<tr>
						...
						<td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="vl">
                              <tr>
                                <td width="2%"><img src="/images/checkbox.gif"></td>
		...
		<legend><strong>TREATMENT INFORMATION</strong></legend>
			<div style="padding:5px 0px 0px 0px">
            	...
            	<div style="padding:0px 0px 5px 0px; border-bottom: 1px solid #CCC">
                	...
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vl">
                      <tr>
                        <td width="35%">Indication for Treatment Initiation:</td>
                        <td width="2%"><img src="/images/checkbox.gif"></td>
                        ...
                        <td width="2%"><img src="/images/checkbox.gif"></td>
                        <td width="13%" style="padding:0px 5px">TB&nbsp;Infection</td>
                      </tr>
                    </table>
                	</div>
                    <div style="padding:5px 0px 0px 0px">
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vl">
                      <tr>
                        ...
                        <td width="25%" style="border-bottom: 1px solid #333">&nbsp;</td>
                      </tr>
                    </table>
                    </div>
                </div>
            	...
            	<div style="padding:0px 0px 5px 0px; border-bottom: 1px solid #CCC">
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vl">
                      <tr>
                        ...
                        <td width="8%" style="padding:0px 5px">Yes</td>
                        <td width="2%"><img src="/images/checkbox.gif"></td>
                        <td width="3%" style="padding:0px 5px">No</td>
                        <td width="15%" style="padding:0px 5px">If&nbsp;Yes,&nbsp;are&nbsp;they&nbsp;on</td>
                        <td width="2%"><img src="/images/checkbox.gif"></td>
                        <td width="12%" style="padding:0px 5px">Initiation, or</td>
                        <td width="2%"><img src="/images/checkbox.gif"></td>
                        <td width="23%" style="padding:0px 5px">Continuation Phase?</td>
                      </tr>
                    </table>
                </div>
