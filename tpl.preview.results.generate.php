...
if($sampleType=="DBS") {
	if(is_numeric($numericVLResult)) {
		if($numericVLResult<5000) {
			$smiley="<img src=\"$home_url/images/smiley.smile.gif\" width=\"100\" height=\"100\" />";
			...
			$smiley="<img src=\"$home_url/images/smiley.sad.gif\" width=\"100\" height=\"100\" />";
...
<page orientation=\"portrait\" format=\"150x220\" style=\"font-size: 9px\">
	<div class=\"special\">
		  ...
		  <!-- End Header -->
		  <!-- Start Text -->
			<div style=\"padding:2px; border-bottom: 1px solid #333; text-align: center\">CENTRAL PUBLIC HEALTH LABORATORIES</div>
			<div style=\"padding:2px 0px 8px 0px; text-align: center\">Viral Load Test Results</div>
		  <!-- End Text -->
